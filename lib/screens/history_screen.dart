...
class _HistoryScreenState extends State<HistoryScreen> {
  ...
  Widget _buildEmptyState() {
    return const Center(
      child: Column(
        ...
        children: [
          Icon(Icons.history_rounded, color: AppTheme.textHint, size: 64),
          SizedBox(height: 16),
          Text(
            'No history yet',
            style: TextStyle(
          ...
          SizedBox(height: 8),
          Text(
            'Add your first fill-up to see history',
  ...
  void _showFullImage(String path, String label) {
    showDialog(
      context: context,
